CLASS zcl_rap_extensions_gen_lgl DEFINITION
INHERITING FROM zcl_rap_extensions_base_lgl
  PUBLIC
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
    ...
    CONSTANTS:
      ...
      co_suffix                     TYPE string           VALUE 'LGL',
...
CLASS zcl_rap_extensions_gen_lgl IMPLEMENTATION.
